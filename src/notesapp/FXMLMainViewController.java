...
public class FXMLMainViewController implements Initializable {
     ...
     * username string from the label. Then it calls the returnDbUserName method
     * with the username string as an argument and does a query for the matching
     * user id. Then it calls the sceneChangeSummary method
     *
     * @param event
     * @throws SQLException
     * @throws IOException
     ...
     * username string from the label. Then it calls the returnDbUserName method
     * with the username string as an argument and does a query for the matching
     * user id. Then it calls the sceneChangeEdit method
     *
     * @param event
     * @throws IOException
     * @throws SQLException
    ...
    /**
     * This method changes scenes to the Summary view using the logged in user
     * id as an argument to be passed to the Summary scene
     *
     * @param event
     * @throws IOException
     */
    ...
    /**
     * This method logs the user out and takes them to the log in scene
     * is pressed
     *
     * @param event
     * @throws IOException
